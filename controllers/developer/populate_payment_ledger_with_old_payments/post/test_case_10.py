...
def validate_create_citation(db_name):
    ...
    for data in data_to_validate:
        ...
        if (db_ticket_status.lower() == "closed"
            ...
            logging.write(True,
                          f"""{test_prefix} {ticket_num}'s passed for adjudication and citation voiding.""")
        else:
            logging.write(False,
                          f"{test_prefix} {ticket_num}'s adjudication or voiding didn't happen properly.")
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_10")
    ...
    tables_to_cleanup = ["local_citation", "local_citation_statuses",
                         ...
                         "adjudication_table", "void_request"]
