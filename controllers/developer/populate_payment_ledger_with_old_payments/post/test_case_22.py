    ...
    for data in data_to_validate:
        ...
        if (db_ticket_status.lower() == "open"
            ...
            logging.write(True,
                          ...
                          f"adjudication and edition.")
        else:
            logging.write(False,
                          f"citation creation or adjudication or edition for {test_prefix} {ticket_num} "
            ...
            for id_, row in enumerate(db_rows):
                ...
                if id_ == 0 and not (db_pos_fine == issued_fine
                    ...
                    logging.write(False,
                                  ...
                                  f"was not properly reversed by back-population in payment ledger.")
                    break
                elif id_ == 5 and not (db_pos_fine == new_fine
                                       and db_category == "fine"
                                       and db_neg_fine == 0):
                    logging.write(False,
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_22")
