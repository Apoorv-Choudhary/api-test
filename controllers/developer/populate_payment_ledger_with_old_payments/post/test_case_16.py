...
def validate_create_citation(db_name):
    test_prefix = "test_case_16:"
    data_to_validate = current_session.get_variable("test_case_16")
    ...
    for data in data_to_validate:
        ...
        if (db_ticket_status.lower() == "open"
            ...
            logging.write(True,
                          f"""{test_prefix} {ticket_num}'s passed for citation creation and escalation.""")
        else:
            logging.write(False,
                          f"escalation of {test_prefix} {ticket_num} didn't happen properly.")
        ...
        if len(db_rows) == 2:
            for id_, row in enumerate(db_rows):
                ...
                logging.write(True, f"payment ledger has properly recorded entries "
                                    ...
                                    f"creation and payment creation.")
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_16")
