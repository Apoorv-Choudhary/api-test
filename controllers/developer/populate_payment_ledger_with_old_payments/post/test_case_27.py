...
def validate_create_citation(db_name):
    test_prefix = "test_case_27:"
    data_to_validate = current_session.get_variable("test_case_27")
        ...
        if len(db_rows) == 4:
            for id_, row in enumerate(db_rows):
                ...
                if id_ == 0 and not (db_pos_fine == issued_fine
                    ...
                    break
                if id_ == 3 and not (db_pos_fine == new_fine
                                     and db_category == "fine"
                                     and db_neg_fine == 0):
                    logging.write(False,
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_27")
