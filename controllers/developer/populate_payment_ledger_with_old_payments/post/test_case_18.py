...
def validate_create_citation(db_name):
    ...
    for data in data_to_validate:
        ...
        if (db_ticket_status.lower() == "1st notice"
            ...
            logging.write(True,
                          f"""{test_prefix} {ticket_num}'s passed for citation edition and escalation.""")
        else:
            logging.write(False,
                          f"citation edition or escalation for {test_prefix} {ticket_num} "
        ...
        if len(db_rows) == 3:
            for id_, row in enumerate(db_rows):
                ...
                logging.write(True, f"payment ledger has properly recorded entries "
                                    ...
                                    f"creation, edition and escalation.")
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_18")
