...
def validate_create_citation(db_name):
    test_prefix = "test_case_25:"
    data_to_validate = current_session.get_variable("test_case_25")
            ...
            for id_, row in enumerate(db_rows):
                ...
                if id_ == 0 and not (db_pos_fine == issued_fine
                    ...
                    logging.write(False,
                                  ...
                                  f"was not properly recorded by back-population in payment ledger.")
                    break
                elif id_ == 4 and not (db_neg_fine == paid_amount
...
def main(*args):
    ...
    test_data = current_session.get_variable("test_case_25")
    ...
    tables_to_cleanup = ["local_citation", "local_citation_statuses",
                         ...
                         "adjudication_table", "local_payment"]
